...
function Btcarritoc(idbtcompra,i,newDiv){ //Crea botones de Compras
      ...
      newbtn.setAttribute("onclick", "valorbt('" + i + "','" + idbtcompra + "');");
...
function valorbt(btvalor,i) {
  alert("Valor: " + btvalor+" Clase de boton: "+i);
}
...
//  alert("El Visor se llama "+idbtcompra + "Numero de imagen: "+i); // da el nombre del control
